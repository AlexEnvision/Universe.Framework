...
namespace Universe.SqlBulkTools
{
    ...
    /// </summary>
    public class BulkOperationsHelpers
    {
        ...
        public string BuildInsertSet(HashSet<string> columns, string sourceAlias, string identityColumn)
        {
            StringBuilder command = new StringBuilder();
        ...
        public string GetFullQualifyingTableName(string databaseName, string schemaName, string tableName)
        {
