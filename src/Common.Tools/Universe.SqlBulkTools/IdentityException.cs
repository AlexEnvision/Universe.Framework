...
{
    /// <summary>
    ///     Исключение, возникающее на столбце-идентификаторе
    /// <author>Alex Envision</author>
    /// </summary>
    internal class IdentityException : Exception
    {
        public IdentityException(string message) : base(message + " Universe.SqlBulkTools requires the SetIdentityColumn method " +
