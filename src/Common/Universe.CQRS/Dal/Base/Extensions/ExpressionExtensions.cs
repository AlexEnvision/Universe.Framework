...
namespace Universe.CQRS.Dal.Base.Extensions
{
    ...
    {
        public static Expression<Func<TDbEntity, object>> CreateExpressionDbeUniversal<TDbEntity>(string propertyName)
            where TDbEntity : class
        {
            var dbEntityType = typeof(TDbEntity);
            ...
            var getterExpression = Expression.Lambda<Func<TDbEntity, object>>(Expression.TypeAs(body, typeof(object)), param);
            return getterExpression;
        }

        public static Expression<Func<TDbEntity, object>> CreateExpressionDbeWithChildUniversal<TDbEntity>(string propertyName, string childProperty)
            where TDbEntity : class
        {
            var dbEntityType = typeof(TDbEntity);
            var hasProp = dbEntityType.GetProperty(propertyName) != null;
            ...
            var getterExpression = Expression.Lambda<Func<TDbEntity, object>>(Expression.TypeAs(childbody, typeof(object)), param);
            return getterExpression;
        }

        public static Expression<Func<TDbEntity, object>> CreateExpressionDbeWithChainPropsUniversal<TDbEntity>(List<string> propChain)
            where TDbEntity : class
        {
            var dbEntityType = typeof(TDbEntity);
        ...
        public static Expression<Func<TDbEntity, object>> CreateExpressionDbeWithChainPropsAndChindProp
            <TDbEntity>(List<string> propChain, string childProperty)
            where TDbEntity : class
        {
            var dbEntityType = typeof(TDbEntity);
            if (propChain == null || propChain.Count == 0)
