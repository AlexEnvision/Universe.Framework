...
namespace Universe.CQRS.Dal.Mappings.FilterMappings
{
    ...
    /// </summary>
    internal class SearchFilterInRuleMapping : AutoMap<InConfiguration, SearchFilterRule>
    {
        protected override void Configure(IMappingExpression<InConfiguration, SearchFilterRule> config)
        {
