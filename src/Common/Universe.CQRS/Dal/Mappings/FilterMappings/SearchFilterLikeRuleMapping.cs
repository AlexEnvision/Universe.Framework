...
namespace Universe.CQRS.Dal.Mappings.FilterMappings
{
    ...
    /// </summary>
    internal class SearchFilterLikeRuleMapping : AutoMap<ContainsConfiguration, SearchFilterRule>
    {
        protected override void Configure(IMappingExpression<ContainsConfiguration, SearchFilterRule> config)
        {
        ...
        {
            var result = FieldFilterTypes.Like;
