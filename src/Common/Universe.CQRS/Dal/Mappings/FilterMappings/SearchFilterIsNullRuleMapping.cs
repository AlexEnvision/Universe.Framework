...
namespace Universe.CQRS.Dal.Mappings.FilterMappings
{
    ...
    /// </summary>
    internal sealed class SearchFilterIsNullRuleMapping : AutoMap<IsNullConfiguration, SearchFilterRule>
    {
        protected override void Configure(IMappingExpression<IsNullConfiguration, SearchFilterRule> config)
        {
