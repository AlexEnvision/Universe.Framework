...
using Universe.CQRS.Models.TableField;

namespace Universe.CQRS.Models.Req
{
    /// <summary>
    ///     Модель запроса сущностей.
    /// <author>Alex Envision</author>
    /// </summary>
    public class GetEntitiesReq
    {
        public GetEntitiesReq()
        {
        ...
        public IList<TableFieldConfiguration> Fields { get; set; }

        [JsonIgnore]
        public bool AllowNoTrackingMode { get; set; }
    }
}
