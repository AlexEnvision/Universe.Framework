...
namespace Universe.CQRS.Security.Principal
{
    ...
    /// </summary>
    public class WebAppIdentity : IIdentity, IWebAppIdentity
    {
        public WebAppIdentity(string loginName)
        {
            Name = loginName ?? throw new ArgumentNullException(nameof(loginName));
            AuthenticationType = "WebApp";
