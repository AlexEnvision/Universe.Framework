...
{
    /// <summary>
    ///      Общеиспользуемые расширения
    /// <author>Alex Envision</author>
    /// </summary>
    public static class Ext
    {
        public static string GeneralizationSymbols(this string str)
        {
            var replaced = Regex.Replace(str, @"[«»]", "\"");
        ...
        {
            return Regex.Replace(str, @"[!@#$%_()\s;:-]", "").Replace("\"", "");
        }
    }
}