...
namespace Universe.Framework.ConsoleApp.Npg.Tests
{
    ...
    /// </summary>
    public class AppTestSettings : IAppSettings
    {
        public string GetUniverseDbConnectionString()
        {
            var connectionString = "Server=localhost;Database=UniversePostgreSqlDb;Port=5432;UserId=postgres;Password=**********;Integrated Security=false;CommandTimeout=300";
