...
using Universe.Framework.ConsoleApp.Npg.Tests.CQRS.Base;
using Universe.Framework.ConsoleApp.Npg.Tests.CQRS.Models;
using Universe.Framework.ConsoleApp.Npg.Tests.Infrastructure;
using Universe.Framework.DataAccess.Npg.Test;
using Universe.Framework.DataAccess.Npg.Test.Models.Traiset;

namespace Universe.Framework.ConsoleApp.Npg.Tests.CQRS
{
    /// <summary>
    ...
    public class CommandQueryTests : BaseCommandQueryTests
    {
        ...
        private TrainsetClassDto GetTrainsetClassDto(string searchTemplate, UniverseScope<UniverseNpgDbTestContext> scope)
        {
        ...
        private TrainsetClassDto CreateTrainSetClass(
            UniverseScope<UniverseNpgDbTestContext> scope,
            Guid sessionId,
        ...
        private TrainsetDto GetTrainSetDto(UniverseScope<UniverseNpgDbTestContext> scope, string searchTemplate)
        {
        ...
        private TrainsetDto CreateTrainSet(UniverseScope<UniverseNpgDbTestContext> scope, Guid sessionId, string searchTemplate)
        {
        ...
        public void CreateEntityCommandTest()
        {
            ...
            var scope = new UniverseScope<UniverseNpgDbTestContext>(settings, container);
        ...
        public void DeleteEntityQueryTest()
        {
            ...
            using (var runningTimeWatcher = new RunningTimeWatcher())
            {
                ...
                Console.WriteLine($@"Количество элементов в таблицы {nameof(TrainsetItemDb)} до удаления: {itemsCount}");
                ...
                Console.WriteLine($@"Количество элементов в таблицы {nameof(TrainsetItemDb)} после удаления: {itemsCountAfter}");
